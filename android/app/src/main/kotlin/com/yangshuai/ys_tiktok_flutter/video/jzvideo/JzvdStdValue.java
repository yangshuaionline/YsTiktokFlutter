...
public class JzvdStdValue extends Jzvd {
    ...
    public JzvdStdValue(Context context) {
        super(context);
    }

    public JzvdStdValue(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.video_jz_layout_std_value;
    }
    ...
    public void onStatePlaying() {
        ...
        EventBus.getDefault().post("PLAYLINE");
    ...
    public void onStatePause() {
        super.onStatePause();
        EventBus.getDefault().post("PAUSEVIDEO");
        changeUiToPauseShow();
